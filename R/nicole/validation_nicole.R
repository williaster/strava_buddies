...
isetwd("~/Dropbox/insight-data-science/project/strava_buddies/R/nicole")
#load(".RData")
f.bigbins           <- "validation_nicole_100x-bins.csv"
f.random.sim        <- "random_similarities_nicole.csv"
f.random.friend.sim <- "random_friend_similarities_nicole.csv"
...
pdf("validation_algs_nicole.pdf", width=5, height=5, useDingbats=FALSE)
p
dev.off()