...
setwd("~/Dropbox/insight-data-science/project/strava_buddies/R/rob")
#load(".RData")
f.bigbins           <- "validation_rob_50x-bins.csv"
f.random.sim        <- "random_medians_rob.csv"
f.random.friend.sim <- "random_friend_medians_rob.csv"
...
pdf("validation_algs_rob.pdf", width=5, height=5, useDingbats=FALSE)
p
dev.off()
